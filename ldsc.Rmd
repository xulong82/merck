...
1. Assuming a uniform prior, you see SNPs with more LD friends showing more associations
2. Under pure genetic drift, we expect LD to have no relationship to differences in allele frequency between populations
